...
class UpdateTodoDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateTodoDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateTodoDto:
        """Create an instance of UpdateTodoDto from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UpdateTodoDto.parse_obj(obj)

        _obj = UpdateTodoDto.parse_obj({
            "color": obj.get("color"),
