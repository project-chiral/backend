...
class EntityOption(BaseModel):
    ...
    alias: StrictStr = ...
    score: StrictFloat = ...
    __properties = ["id", "name", "alias", "score"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityOption:
        """Create an instance of EntityOption from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EntityOption.parse_obj(obj)

        _obj = EntityOption.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "alias": obj.get("alias"),
            "score": obj.get("score")
