...
class RelationProperty(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationProperty:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationProperty:
        """Create an instance of RelationProperty from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RelationProperty.parse_obj(obj)

        _obj = RelationProperty.parse_obj({
