...
class CreateSceneDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSceneDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSceneDto:
        """Create an instance of CreateSceneDto from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateSceneDto.parse_obj(obj)

        _obj = CreateSceneDto.parse_obj({
            "name": obj.get("name"),
